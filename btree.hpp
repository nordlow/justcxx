...
void
Node::insert_zeroth_subtree (Node * subtree)
{
...
// limit the size of the vector to 4 kilobytes max and 200 entries max.
  ...
  int
    num_elements = max_elements * sizeof (Elem) <= max_array_bytes ?
...
bool
Node::vector_insert (Elem & element)
{
...
bool
Node::vector_delete (Elem & target)
{
...
bool
Node::vector_delete (int target_pos)
{
...
bool
Node::vector_insert_for_split (Elem & element)
{
...
bool
Node::split_insert (Elem & element)
{
...
bool
Node::delete_element (Elem & target)
{
