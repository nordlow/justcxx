// \file t_avcodec.c
// \brief A small sample program that shows how to use libavformat and libavcodec to
// read video from a file.
// avcodec_sample version 0.5.0.c
//
...
// considerably.
//
// @build gcc -o t_avcodec t_avcodec.c -lavformat -lavcodec -lavutil -lswscale -lz -lbz2
// @run t_avcodec myvideofile.mpg
