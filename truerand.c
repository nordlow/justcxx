...
/*
 * WARNING: depending on the particular platform, \c raw_truerand()
 ...
 * random numbers, can be found in \c trand8(), \c trand16(), and \c trand32().
 * Use those instead of calling \c raw_truerand() directly.
 *
